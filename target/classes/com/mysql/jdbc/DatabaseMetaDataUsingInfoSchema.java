...
public class DatabaseMetaDataUsingInfoSchema extends DatabaseMetaData {
    ...
    public ResultSet getColumnPrivileges(String catalog, String schema, String table, String columnNamePattern) throws SQLException {
        ...
        try {
            ...
            ((ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "TABLE_CAT", Types.CHAR, 64),
    ...
    public ResultSet getPrimaryKeys(String catalog, String schema, String table) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "TABLE_CAT", Types.CHAR, 255),
    ...
    public ResultSet getVersionColumns(String catalog, String schema, String table) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "SCOPE", Types.SMALLINT, 5),
    ...
    public ResultSet getFunctions(String catalog, String schemaPattern, String functionNamePattern) throws SQLException {
        ...
        try {
            ...
            ResultSet rs = executeMetadataQuery(pStmt);
            ((ResultSetInternalMethods) rs).redefineFieldsForDBMD(new Field[] { new Field("", "FUNCTION_CAT", Types.CHAR, 255),
