...
public class StatementImpl implements Statement {
    ...
    protected boolean createStreamingResultSet() {
        return ((this.resultSetType == ResultSet.TYPE_FORWARD_ONLY) && (this.resultSetConcurrency == ResultSet.CONCUR_READ_ONLY) &&
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            this.generatedKeysResults = ResultSetImpl.getInstance(this.currentCatalog, fields, new RowDataStatic(this.batchedGeneratedKeys),
    ...
    protected ResultSetInternalMethods getGeneratedKeysInternal(int numKeys) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            ResultSetImpl gkRs = ResultSetImpl.getInstance(this.currentCatalog, fields, new RowDataStatic(rowSet),
                    this.connection, this, false);
